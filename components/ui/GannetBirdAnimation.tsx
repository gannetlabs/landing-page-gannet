...
export default function GannetBirdAnimation({
  ...
  // revealed=true una vez que el stroke draw termina y el fill puede mostrarse
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 1. Glow burst — solo visible en hover */}
        <motion.path
          d={BIRD_PATH}
          fill="#00EE8E"
          filter="url(#gannet-glow-intense)"
          animate={{ opacity: revealed && hovered ? 0.45 : 0 }}
          transition={{ duration: 0.5 }}
        />

        {/* 2. Stroke draw — blanco sutil, se traza una sola vez al montar */}
        <motion.path
          d={BIRD_PATH}
          fill="transparent"
        ...
        {/* 3. Fill whitemark — aparece al terminar el stroke, desaparece en hover */}
        <motion.path
          d={BIRD_PATH}
          fill="rgba(255,255,255,0.10)"
          animate={{ opacity: revealed && !hovered ? 1 : 0 }}
          transition={{ duration: 0.5 }}
        />

        {/* 4. Fill verde con glow — invisible por defecto, aparece en hover */}
        <motion.path
          d={BIRD_PATH}
          fill="#00EE8E"
